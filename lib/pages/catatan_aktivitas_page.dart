...
class CatatanAktivitasPage extends StatelessWidget {
  const CatatanAktivitasPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarPrimary(title: 'Catatan Aktivitas'),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            verticalSpace(8),
            Text(
              'Catatan Aktivitas Kosong, Silahkan membuat catatan aktivitas sekarang',
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                border:
                                    Border.all(color: AssetColors.greyLight),
